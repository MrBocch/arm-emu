...
func updateRegisters() {
	...
	R3Label.SetText(fmt.Sprintf("R3:  0x%08X", vm.registers[3]))
	R4Label.SetText(fmt.Sprintf("R4:  0x%08X", vm.registers[4]))
	R5Label.SetText(fmt.Sprintf("R5:  0x%08X", vm.registers[5]))
